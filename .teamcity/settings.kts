...
project {
	...
	params {
		...
		password("CONFIG_E2E_ENCRYPTION_KEY_JAN_22", "credentialsJSON:28f1cadd-35d5-44b1-bdca-4228fe2948b7", display = ParameterDisplay.HIDDEN)
		param("E2E_CONFIG_ENCRYPTION_KEY", "%CONFIG_E2E_ENCRYPTION_KEY_JAN_22%")
